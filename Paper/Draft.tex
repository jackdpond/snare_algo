...
\includegraphics[width=0.95\textwidth]{figures/feature_distributions.pdf} % Better to make them pdfs than png or gif or jpeg
\end{center}
\vspace{-0.1cm}
...
\begin{figure}[!htbp]
\begin{center} %Put your images in a figure like this
\includegraphics[width=0.95\textwidth]{figures/results_box_plots.pdf} % Better to make them pdfs than png or gif or jpeg
\end{center}
\vspace{-0.1cm}
...
WOBA would be more significant in the post season. However, our results are consistent with baseball intuition: pitching wins games. We also found that being a wild card team was not nearly as significant as we expected, ranking last in feature importance. 
See Figure~\ref{fig:PostseasonPermImportance}.

\begin{figure}[H]
  \begin{center}
    \includegraphics[width=0.9\textwidth]{figures/features_importance.pdf}
  \end{center}
...
\par Taken together, these results suggest what teams should try to optimize for in the postseason. Having a talented, well rested bullpen and a strong starting pitcher appear to be key ingredients for postseason success. More work remains to be done as to how to optimize bullpen management to preserve pitchers' arms while making it to the playoffs in the first place
