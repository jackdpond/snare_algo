...
\par Recent MLB postseasons have shown an interesting trend: Wild Card teams often perform better than division winners, even though they typically finish the regular season with weaker records. This raises an important questions for both baseball fans and analysts:
...
\par In conclusion, our project revealed that postseason pitching is the most important factor in determining success. Our original hypthesis that Wild Card teams would perform better than division winners was not supported by our findings. 
